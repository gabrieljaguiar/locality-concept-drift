...
single_class_local <- read.csv(file = "../datasets/datasets/multi_class_local_swap_cluster_ds_10000_c_3_ca_3_f_2_1_1.csv")
...
before <- c(35000:37500)
during <- c(55000:57500)
after <- c(92501:95000)
